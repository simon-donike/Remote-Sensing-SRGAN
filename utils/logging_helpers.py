...
def plot_tensors_S2(lr, sr, title="Train",stretch=None):
    ...
    fixed_width = 15
    variable_height = (15/3) * B
    fig, axes = plt.subplots(B, 2, figsize=(fixed_width, variable_height))
